...
static const
unsigned short gb2312_2uni_page21[831] = {
  /* 0x21 */
...
static const
unsigned short gb2312_2uni_page30[6768] = {
  /* 0x30 */
...
static int
GB2312_Decode(StreamStruct *Codec, StreamStruct *NextCodec)
{
...
static int
GB2312_Encode(StreamStruct *Codec, StreamStruct *NextCodec)
{
	unsigned char	*In=Codec->Start;
	unsigned char	*Out=NextCodec->Start+NextCodec->Len;
	unsigned char	*OutEnd=NextCodec->End;
