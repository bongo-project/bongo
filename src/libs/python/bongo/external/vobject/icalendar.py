...
class TimezoneComponent(Component):
    ...
    def registerTzinfo(obj, tzinfo):
        ...
        return tzid
    registerTzinfo = classmethod(registerTzinfo)
    ...
    pickTzid = staticmethod(pickTzid)
        ...
        for name in DATESANDRULES:
            ...
            for line in self.contents.get(name, ()):
                ...
                if name in DATENAMES:
                    ...
                    addfunc(rrule.rrulestr(str(line.value),
                                                    dtstart=dtstart))
            ...
            if name in DATENAMES:
                ...
                for rule in setlist:
                    ...
                    if rule._bymonth is not None and len(rule._bymonth) > 0:
                        if not (rule._freq == rrule.YEARLY and
...
class RecurringBehavior(behavior.Behavior):
    ...
    generateImplicitParameters = staticmethod(generateImplicitParameters)
