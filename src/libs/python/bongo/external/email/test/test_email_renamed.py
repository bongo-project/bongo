...
from bongo.external.email.charset import Charset
from bongo.external.email.header import Header, decode_header, make_header
from bongo.external.email.parser import Parser, HeaderParser
from bongo.external.email.generator import Generator, DecodedGenerator
from bongo.external.email.message import Message
from bongo.external.email.mime.application import MIMEApplication
from bongo.external.email.mime.audio import MIMEAudio
from bongo.external.email.mime.text import MIMEText
from bongo.external.email.mime.image import MIMEImage
from bongo.external.email.mime.base import MIMEBase
from bongo.external.email.mime.message import MIMEMessage
from bongo.external.email.mime.multipart import MIMEMultipart
from bongo.external.email import utils
from bongo.external.email import errors
from bongo.external.email import encoders
from bongo.external.email import iterators
from bongo.external.email import base64mime
from bongo.external.email import quoprimime

from test.test_support import findfile, run_unittest
from bongo.external.email.test import __file__ as landmark
...
class TestEmailBase(unittest.TestCase):
    ...
    def _msgobj(self, filename):
        ...
        try:
            msg = bongo.external.email.message_from_file(fp)
        finally:
            fp.close()
        return msg
...
class TestMessageAPI(TestEmailBase):
    ...
    def test_bad_param(self):
        msg = bongo.external.email.message_from_string("Content-Type: blarg; baz; boo\n")
        self.assertEqual(msg.get_param('baz'), '')

    def test_missing_filename(self):
        msg = bongo.external.email.message_from_string("From: foo\n")
        self.assertEqual(msg.get_filename(), None)

    def test_bogus_filename(self):
        msg = bongo.external.email.message_from_string(
...

# Test the bongo.external.email.encoders module
...
class TestIdempotent(TestEmailBase):
    def _msgobj(self, filename):
        ...
        try:
            ...
            fp.close()
        msg = bongo.external.email.message_from_string(data)
        return msg, data
...
class TestMiscellaneous(TestEmailBase):
    def test_message_from_string(self):
        ...
        try:
            ...
            fp.close()
        msg = bongo.external.email.message_from_string(text)
        s = StringIO()
    ...
    def test_message_from_string_with_class(self):
        ...
        msg = bongo.external.email.message_from_string(text, MyMessage)
    ...
    def test_message_from_file_with_class(self):
        ...
        fp = openfile('msg_01.txt')
        try:
            msg = bongo.external.email.message_from_file(fp, MyMessage)
        finally:
            fp.close()
        unless(isinstance(msg, MyMessage))
        # Try something more complicated
...
""")
    ...
    def test_three_lines(self):
        ...
        msg = bongo.external.email.message_from_string(NL.join(lines))
...
class TestCharset(unittest.TestCase):
    def tearDown(self):
        from bongo.external.email import charset as CharsetModule
        try:
