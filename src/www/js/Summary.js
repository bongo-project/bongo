    ...
    if (!$('summary-view')) {
        ...
        Element.setHTML ('content-iframe', 
                         ['<div class="scrollv" id="summary-view">',
                          ...
                          '<td style="vertical-align:middle;">', _('You do not seem to have any new or unread emails.'), '</td>',
                          '</tr></table></div>',
                          '</td> ',
                          '<td class="summary-column"> ',
