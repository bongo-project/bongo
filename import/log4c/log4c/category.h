/* $Id: category.h,v 1.5 2005/12/15 19:39:51 legoater Exp $
 *
 * category.h
 * 
                                             ...
                                             va_list a_args)
{
    ...
    __log4c_category_vlog(a_category, &locinfo, id, a_priority, a_format, a_args);
}

/** 
 * Log a message with the specified priority.
 * @param a_category the log4c_category_t object
 * @param id the ID of the event for backwards compatibility, or 0
                                            ...
                                            ...)
{
	...
	log4c_category_vlog(a_category, id, a_priority, a_format, va);
	va_end(va);
    }
}
                                              ...
                                              ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_FATAL, a_format, va);
	va_end(va);
    }
}
                                              ...
                                              ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_ALERT, a_format, va);
	va_end(va);
    }
}
                                             ...
                                             ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_CRIT, a_format, va);
	va_end(va);
    }
}
                                              ...
                                              ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_ERROR, a_format, va);
	va_end(va);
    }
}
                                             ...
                                             ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_WARN, a_format, va);
	va_end(va);
    }
}
                                               ...
                                               ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_NOTICE, a_format, va);
	va_end(va);
    }
}
                                             ...
                                             ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_INFO, a_format, va);
	va_end(va);
    }
}
                                              ...
                                              ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_DEBUG, a_format, va);
	va_end(va);
    }
}
                                                ...
                                                ...)
{
	...
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, id, LOG4C_PRIORITY_TRACE, a_format, va);
	va_end(va);
    }
}
